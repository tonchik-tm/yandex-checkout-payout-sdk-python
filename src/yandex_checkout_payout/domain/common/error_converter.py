...
class ErrorConverter:
    ...
    def get_error_list():
        return {
            ...
            30: 'Technical problems on the Yandex.Money side. '
            ...
            40: 'Account closed.',
            41: 'Yandex.Money Wallet blocked. This operation is not allowed for this wallet.',
            ...
            53: 'The request was signed by a certificate unknown to Yandex.Money.',
            ...
            201: 'Exceeded the limit on the recipient\'s account balance (internal code, not sent to contractors, '
                 'used by Yandex.Money\'s) technical specialists)',
        }
